  ...
  async function handleUpdateTrip() {
    try {
      ...
      if (!destination || !selectedDates.startsAt || !selectedDates.endsAt) {
        return Alert.alert("atualizar viagem",
          "Lembre-se de, além de preencher o destino, selecionar as datas de inicio e fim."
        )
      }
  ...
  return (
    <View className="flex-1 px-5 pt-16">
      ...
      <View className="w-full absolute -bottom-1 self-center justify-end pb-5 z-10 bg-zinc-950">
        <View className="w-full flex-row  bg-zinc-900 p-4 rounded-lg border border-zinc-800 gap-2 justify-center">
